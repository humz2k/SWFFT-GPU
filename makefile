...
main: $(DFFT_BUILD_DIR)/testdfft $(DFFT_BUILD_DIR)/benchmark $(DFFT_BUILD_DIR)/testks $(DFFT_BUILD_DIR)/testalltoallgpu $(DFFT_ARC) $(DFFT_BUILD_DIR)/testdfftc
...
$(DFFT_BINDINGS_LIB_DIR)/%.o: bindings/%.cpp | $(DFFT_AR) $(DFFT_BUILD_DIR)
	$(DFFT_MPI_CXX) -c -fPIC $(GPU_FLAG) $(DFFT_CUDA_MPI) -DSWFFT_$(DFFT_GPU) $(DFFT_DIST_BACKEND_DEFINES) $(DFFT_FFT_BACKEND_DEFINES) $(DFFT_INCLUDE) $^ $(DFFT_FFTW_LDFLAGS) $(DFFT_OPENMP) -L$(DFFT_CUDA_LIB) $(DFFT_CUDA_LD) -o $@


$(DFFT_BUILD_DIR)/%: test/%.cpp $(DFFT_AR) | $(DFFT_BUILD_DIR)
	$(DFFT_MPI_CXX) $(GPU_FLAG) $(DFFT_CUDA_MPI) -DSWFFT_$(DFFT_GPU) $(DFFT_DIST_BACKEND_DEFINES) $(DFFT_FFT_BACKEND_DEFINES) $(DFFT_INCLUDE) $^ $(DFFT_FFTW_LDFLAGS) $(DFFT_OPENMP) -L$(DFFT_CUDA_LIB) $(DFFT_CUDA_LD) -fPIC -o $@

$(DFFT_BUILD_DIR)/%: test/%.c $(DFFT_ARC) | $(DFFT_BUILD_DIR)
	$(DFFT_MPI_CC) $(GPU_FLAG) $(DFFT_CUDA_MPI) -DSWFFT_$(DFFT_GPU) $(DFFT_DIST_BACKEND_DEFINES) $(DFFT_FFT_BACKEND_DEFINES) $(DFFT_INCLUDE) $^ $(DFFT_FFTW_LDFLAGS) $(DFFT_OPENMP) -L$(DFFT_CUDA_LIB) $(DFFT_CUDA_LD) -fPIC -o $@
...
$(DFFT_LIB_DIR)/%.o: src/%.cpp | $(DFFT_LIB_DIR)
	$(DFFT_MPI_CXX) $(GPU_FLAG) $(DFFT_CUDA_MPI) -DSWFFT_$(DFFT_GPU) $(DFFT_DIST_BACKEND_DEFINES) $(DFFT_FFT_BACKEND_DEFINES) $(DFFT_INCLUDE) $(DFFT_OPENMP) -fPIC -c -o $@ $<
