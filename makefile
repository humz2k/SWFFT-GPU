...
$(DFFT_BUILD_DIR)/%: test/%.cpp $(DFFT_AR) | $(DFFT_BUILD_DIR)
	$(DFFT_MPI_CXX) $(GPU_FLAG) $(DFFT_CUDA_MPI) -DSWFFT_$(DFFT_GPU) $(DFFT_DIST_BACKEND_DEFINES) $(DFFT_FFT_BACKEND_DEFINES) $(DFFT_INCLUDE) $^ $(DFFT_FFTW_LDFLAGS) -L$(DFFT_CUDA_LIB) $(DFFT_CUDA_LD) -o $@
...
$(DFFT_LIB_DIR)/%.o: src/%.cpp | $(DFFT_LIB_DIR)
	$(DFFT_MPI_CXX) $(GPU_FLAG) $(DFFT_CUDA_MPI) -DSWFFT_$(DFFT_GPU) $(DFFT_DIST_BACKEND_DEFINES) $(DFFT_FFT_BACKEND_DEFINES) $(DFFT_INCLUDE) -c -o $@ $<
