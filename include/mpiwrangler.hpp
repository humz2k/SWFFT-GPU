...
class GPUIsend{
    ...
    public:
        GPUIsend();
        GPUIsend(T* in_buff_, int n_, int dest_, int tag_, MPI_Comm comm_);
        ~GPUIsend();
...
class GPUIrecv{
    ...
    public:
        GPUIrecv();
        GPUIrecv(T* my_out_buff, int n, int source, int tag, MPI_Comm comm);
        ~GPUIrecv();
...
class GPUMPI{
    public:
        ...
        GPUIsend<complexDoubleDevice>* isend(complexDoubleDevice* buff, int n, int dest, int tag, MPI_Comm comm);
        GPUIsend<complexFloatDevice>* isend(complexFloatDevice* buff, int n, int dest, int tag, MPI_Comm comm);

        GPUIsend<complexDoubleHost>* isend(complexDoubleHost* buff, int n, int dest, int tag, MPI_Comm comm);
        GPUIsend<complexFloatHost>* isend(complexFloatHost* buff, int n, int dest, int tag, MPI_Comm comm);

        GPUIrecv<complexDoubleDevice>* irecv(complexDoubleDevice* buff, int n, int dest, int tag, MPI_Comm comm);
        GPUIrecv<complexFloatDevice>* irecv(complexFloatDevice* buff, int n, int dest, int tag, MPI_Comm comm);

        GPUIrecv<complexDoubleHost>* irecv(complexDoubleHost* buff, int n, int dest, int tag, MPI_Comm comm);
        GPUIrecv<complexFloatHost>* irecv(complexFloatHost* buff, int n, int dest, int tag, MPI_Comm comm);
